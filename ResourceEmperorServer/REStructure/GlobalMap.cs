    ...
    public class GlobalMap
    {
        ...
        public GlobalMap()
        {
            ...
            Town startTown = new Town( 
                ...
                {
                    new Commodity(new Log(1), 800, 800, 1000, 20, 1.0),
                    new Commodity(new Oak(1), 200, 200, 400, 60, 1.2),
                    new Commodity(new Bamboo(1), 700, 700, 800, 15, 0.8),
                    new Commodity(new Cypress(1), 60, 60, 400, 100, 1.5),
                    new Commodity(new Hemp(1), 750, 750, 1000, 10, 0.8),
                    new Commodity(new Coconut(1), 20, 20, 300, 30, 1.0),
                    new Commodity(new RawRubber(1), 50, 50, 300, 10, 1.0),
                    new Commodity(new Cotton(1), 1800, 1800,2400, 10, 0.9),
                    new Commodity(new CopperOre(1), 300, 300, 1000, 80, 1.2),
                    new Commodity(new IronOre(1), 300, 300, 1000, 80, 1.3),
                    new Commodity(new Coal(1), 300, 300, 1000, 50, 1.1),
                    new Commodity(new Timber(1), 400, 400, 2000, 25, 1.0),
                    new Commodity(new HempRope(1), 300, 300, 1000, 60, 1.0),
                    new Commodity(new Firewood(1), 4000, 4000, 10000, 8, 0.6),
                    new Commodity(new OakTimber(1), 200, 200, 1000, 80, 1.2),
                    new Commodity(new CypressTimber(1), 200, 200, 1000, 150, 1.5),
                    new Commodity(new Brick(1), 500, 500, 2000, 20, 1.0),
                    new Commodity(new Charcoal(1), 400, 400, 2000, 12, 1.0),
                    new Commodity(new Rubber(1), 50, 50, 400, 30, 1.0),
                    new Commodity(new WroughIron(1), 20, 20, 400, 400, 1.5),
                    new Commodity(new Copper(1), 20, 20, 400, 400, 1.4)
                }));
            {
                #region 邊緣地帶地圖
